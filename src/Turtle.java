...
/**
 * This class inherits from RideObject, which represents Turtles.
 */
public class Turtle extends RideObject{
	 ...
	 */
	public Turtle(String imageSrc, float x, float y, boolean objectDirection, double speed) throws SlickException {
